function getInputValue(){
    ...
    if(inputVal==80){
        document.getElementById("demo").innerHTML ="SAAD HUSSAIN";
        document.getElementById("demo1").innerHTML ="10000";
    }
    else if(inputVal==15)
    {
        document.getElementById("demo").innerHTML ="SYED HISHAM AKMAL";
        document.getElementById("demo1").innerHTML ="0";  
    }
    else if(inputVal==3)
    {
        document.getElementById("demo").innerHTML ="NARENDRA SINGH PUROHIT";
        document.getElementById("demo1").innerHTML ="10000";   
    }

    else if(inputVal==4)
    {
        document.getElementById("demo").innerHTML ="K RAMACHANDRA SHENOY";
        document.getElementById("demo1").innerHTML ="10000";   
    }
    else if(inputVal==5)
    {
